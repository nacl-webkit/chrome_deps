...
// FIXME  return (new PPB_Broker_Impl(instance))->GetReference();
}

PP_Resource ResourceCreationImpl::CreateBuffer(PP_Instance instance,
                                               uint32_t size) {
// FIXME  return PPB_Buffer_Impl::Create(instance, size);
}

PP_Resource ResourceCreationImpl::CreateDirectoryReader(
    PP_Resource directory_ref) {
// FIXME  return PPB_DirectoryReader_Impl::Create(directory_ref);
}
...
// FIXME  return PPB_FileSystem_Impl::Create(instance, type);
}
...
// FIXME  return PPB_Flash_MessageLoop_Impl::Create(instance);
}
...
PP_Resource ResourceCreationImpl::CreateHostResolverPrivate(
    PP_Instance instance) {
// FIXME  return (new PPB_HostResolver_Private_Impl(instance))->GetReference();
}
...
PP_Resource ResourceCreationImpl::CreateImageDataNaCl(PP_Instance instance,
                                                      ...
                                                      const PP_Size& size,
                                                      PP_Bool init_to_zero) {
// FIXME  return PPB_ImageData_Impl::CreateNaCl(instance, format, size, init_to_zero);
}
...
PP_Resource ResourceCreationImpl::CreateNetworkMonitor(
    ...
    void* user_data) {
// FIXME  return PPB_NetworkMonitor_Private_Impl::Create(instance, callback, user_data);
}

PP_Resource ResourceCreationImpl::CreateScrollbar(PP_Instance instance,
                                                  PP_Bool vertical) {
// FIXME  return PPB_Scrollbar_Impl::Create(instance, PP_ToBool(vertical));
}
...
PP_Resource ResourceCreationImpl::CreateTCPServerSocketPrivate(
    PP_Instance instance) {
// FIXME  return PPB_TCPServerSocket_Private_Impl::CreateResource(instance);
}

PP_Resource ResourceCreationImpl::CreateTCPSocketPrivate(PP_Instance instance) {
// FIXME  return PPB_TCPSocket_Private_Impl::CreateResource(instance);
}
...
PP_Resource ResourceCreationImpl::CreateX509CertificatePrivate(
    PP_Instance instance) {
// FIXME  return PPB_X509Certificate_Private_Impl::CreateResource(instance);
}
